...
#symphon phonopy-irreps --params phonopy_params.yaml --chiral --compare-supercell-labels
symphon phonopy-irreps --params phonopy_params.yaml  --compare-supercell-labels
